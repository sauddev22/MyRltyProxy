...
module.exports = {
  ...
  ***************************************************************************/
  ...
  MAIL: {
    ...
    MAIL_AUTH_USER: process.env.MAIL_AUTH_USER, // generated ethereal user
    MAIL_AUTH_PASS: process.env.MAIL_AUTH_PASS, // generated ethereal password
    MAIL_INFO_FROM: process.env.MAIL_INFO_FROM, // sender address
    MAIL_SECURE: process.env.MAIL_SECURE, // sender address
  },
  // auth_url: 'http://3.137.214.33:1337/api/v1/',
  // api_url: 'http://18.189.193.71:1337/api/v1/',
