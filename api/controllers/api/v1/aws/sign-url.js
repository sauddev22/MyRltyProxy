module.exports = {
  ...
  fn: async function (inputs, exits) {
    sails.log.debug('Running api/v1/aws/sign-url with inputs ' + JSON.stringify(inputs));
    try {
      ...
      sails.log.error('error calling api/v1/aws/sign-url', err.message);
