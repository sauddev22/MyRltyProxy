module.exports = {
    ...
    fn: async function (inputs, exits) {
        sails.log.debug('Running api/v1/admin/subscriptions/update.js with inputs ' + JSON.stringify(inputs));
        try {
            ...
            sails.log.error('error calling  api/v1/admin/subscriptions/update.js ', err.message);
            [exitsName, responseData] = await sails.helpers.response.with({
