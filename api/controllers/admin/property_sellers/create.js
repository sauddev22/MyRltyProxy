module.exports = {
    ...
    description: 'creating property seller',
    ...
    fn: async function (inputs, exits) {
        sails.log.debug('Running api/v1/user/property_sellers/create.js with inputs ' + JSON.stringify(inputs));
        try {
            const { status, data, headers } = await sails.helpers.request.with({
                req: this.req,
                type: 'POST',
                server: 'LOGIC',
                endpoint: 'admin/property_sellers',
                params: inputs
